  ...
  <div className="mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div className="pl-[5%] sm:pl-[10%] mx-auto h-auto sm:h-[640px] max-w-[1485px] flex flex-col lg:flex-row items-center gap-12">
      ...
      >
        ...
        <p className="font-normal text-base sm:text-lg text-[#666666] leading-6 sm:leading-[26px] mt-4">
          From daily pick-and-drop services to tailored <br className="hidden sm:block" />{" "}
          travel experiences, we’ve got you covered
        </p>
...
<section className="py-16 px-4 max-w-[1186px] mx-auto">
  ...
  >
    ...
    <div className="flex-1 space-y-8 md:max-w-[340px] w-full md:w-auto px-4 md:px-0">
      {[
        { img: "/images/hours.png", title: "Set Your Own Hours", desc: "Enjoy flexibility and freedom by setting your own hours with EasyDrop." },
        { img: "/images/paid.png", title: "Get Paid Fast", desc: "Earn securely and get paid quickly with our reliable payment system." },
        { img: "/images/support.png", title: "Get Support At Every Time", desc: "Receive 24/7 support to ensure a seamless and hassle-free experience." }
      ].map((item, index) => (
        <motion.div
          key={index}
        ...
        >
          <img src={item.img} alt="" className="w-[30px] h-[30px] flex-shrink-0" />
          <div>
            ...
            <p className="text-[#2D2D2D] font-normal text-sm md:text-base leading-[24px] md:leading-[27px]">{item.desc}</p>
          </div>
        </motion.div>
      ))}
    </div>
    ...
    >
      <img src="/images/Groupcar.png" alt="Car illustration" className="w-[79px] h-[395px] md:h-[495px]" />
    </motion.div>

    {/* Right Column */}
    <div className="flex-1 space-y-8 md:max-w-[340px] w-full md:w-auto px-4 md:px-0">
      {[
        { img: "/images/pace.png", title: "Onboard People At Your Own Pace", desc: "Onboard people effortlessly and at your own pace with complete flexibility." },
        { img: "/images/sides.png", title: "Safe Rides, Reliable Service", desc: "Enjoy safe rides and reliable service every time you travel with us." },
        { img: "/images/anywhere.png", title: "Go Anywhere With Easy Drop", desc: "Travel anywhere with ease and reliability, only with Easy Drop." }
      ].map((item, index) => (
        <motion.div
          key={index}
          initial={{ opacity: 0, x: 20 }}
  ...
  <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-36 2xl:px-36">
    ...
    >
      <h2 className="text-[38px] font-semibold leading-[42px]">
        Our <span className="bg-gradient-to-b from-[#2E2C80] to-[#2458A4] text-transparent bg-clip-text">Expert</span> Drivers
      </h2>

    ...
    <div className="max-w-3xl mx-auto p-4 sm:p-6">
      ...
      <div className="space-y-4">
        {faqData.map((item, index) => (
          <div
            key={index}
            className="border border-gray-200 bg-[#F2F4F6] rounded-lg shadow-sm overflow-hidden"
          >
            <button
            ...
            >
              ...
              <div
                className={`flex items-center justify-center text-center w-8 h-8 rounded-full transition-transform duration-300 sm:w-9 sm:h-9 ${openIndex === index
